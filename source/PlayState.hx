...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if (curStage == 'test')
			{
					froggo = new FlxSprite();
					froggo.frames = Paths.getSparrowAtlas("toadies");
					froggo.animation.addByPrefix("vibe", "Toadies_idle", 24, true); 
					froggo.animation.addByPrefix("cheer", "Toadies_cheer", 24, false); 
					froggo.animation.play("vibe");
					froggo.setGraphicSize(Std.int(froggo.width * 1.2));
					add(froggo);
			}
		...
		{
			case 'senpai':
				dad2 = new Character(dad.x + 200, dad.y - 20, 'alpha');
				add(dad2);
				dad3 = new Character(dad.x - 130, dad.y + 300, 'senpai');
				dad3.alpha = 0;
				add(dad3);
			case 'roses':
				dad2 = new Character(dad.x + 200, dad.y - 20, 'alphamad');
				add(dad2);
				dad3 = new Character(dad.x - 130, dad.y + 300, 'senpai');
				dad3.alpha = 0;
		}
					...
					if (!daNote.mustPress && daNote.wasGoodHit)
					{
						...
						switch (Math.abs(daNote.noteData))
						{
							case 2:
								...
								case 'dad3':
									dad3.playAnim('singUP' + altAnim, true);
								default:
							...
							case 3:
								...
								case 'dad3':
									dad3.playAnim('singRIGHT' + altAnim, true);
								default:
							...
							case 1:
								...
								case 'dad3':
									dad3.playAnim('singDOWN' + altAnim, true);
								default:
							...
							switch (daNote.noteType){
								...
								case 'dad3':
									dad3.playAnim('singLEFT' + altAnim, true);
								default:
